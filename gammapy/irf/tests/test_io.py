...
def test_cta_irf_alpha_config_south():
    """Test that CTA IRFs can be loaded and evaluated."""
    irf = load_cta_irfs(
        "$GAMMAPY_DATA/cta-alpha_config/Prod5-South-20deg-AverageAz-14MSTs37SSTs.180000s-v0.1.fits"
    )
...
def test_cta_irf_alpha_config_south():
    """Test that CTA IRFs can be loaded and evaluated."""
    irf = load_cta_irfs(
        "$GAMMAPY_DATA/cta-alpha_config/Prod5-North-20deg-AverageAz-4LSTs09MSTs.180000s-v0.1.fits"
    )
